...
import com.android.alice.resume.model.BasicInfo;
import com.android.alice.resume.model.Education;
import com.android.alice.resume.model.Experience;
import com.android.alice.resume.model.Project;
import com.android.alice.resume.util.DateUtils;
import com.android.alice.resume.util.ImageUtils;
import com.android.alice.resume.util.ModelUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateEducation(Education education) {
        ...
        ModelUtils.save(this, MODEL_EDUCATIONS, education);
        setupEducations();
    }
    ...
    private void updateExperience(Experience experience) {
        ...
        ModelUtils.save(this, MODEL_EXPERIENCES, experience);
        setupExperiences();
    }
    ...
    private void updateProject(Project project) {
        ...
        ModelUtils.save(this, MODEL_PROJECTS, project);
        setupProjects();
    }
