...
public class ExperienceEditActivity extends EditBaseActivity<Experience> {
    ...
    protected int getLayoutId() {
        return R.layout.experience_edit_item;
    }
    ...
    protected void setupUIForEdit(@NonNull final Experience data) {
        ...
        ((EditText)findViewById(R.id.experience_edit_start_date)).setText(dateToString(data.startDate));
        ((EditText)findViewById(R.id.experience_edit_end_date)).setText(dateToString(data.endDate));
