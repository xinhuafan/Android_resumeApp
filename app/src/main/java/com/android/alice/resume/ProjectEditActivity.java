...
public class ProjectEditActivity extends EditBaseActivity<Project> {
    ...
    protected int getLayoutId() {
        return R.layout.project_edit_item;
    }
    ...
    protected void setupUIForEdit(@NonNull final Project data) {
        ...
        ((EditText)findViewById(R.id.project_edit_start_date)).setText(dateToString(data.startDate));
        ((EditText)findViewById(R.id.project_edit_end_date)).setText(dateToString(data.endDate));
